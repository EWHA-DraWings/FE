...
// import 'package:sodam/models/login_data_provider.dart';
...
//   // 로그인 버튼 누르면 실행
//   Future<void> loginAction(id, password) async {
//     try {
//       var param = {
//         'id': id,
//         'password': password,
...
//         print(jsonBody);
//         //isElderly 값 가져오기
//         bool isElderly = jsonBody['isElderly'];//is Elderly를 이렇게 가져와야 하나?
...
//         Provider.of<LoginDataProvider>(context, listen: false).setLoginData(loginData);
  ...
  _asyncMethod() async {
    ...
    if (userInfo != null) {
      Navigator.pushReplacement(
        context,
        MaterialPageRoute(
          builder: (context) => MainScreen(isGuardian: false), // 이 정보도 수정 필요
        ),
      );
    }
  }
